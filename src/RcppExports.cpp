...
RcppExport SEXP _gpbart2_log_dmvn(SEXP xSEXP, SEXP SigmaSEXP) {
BEGIN_RCPP
...
RcppExport SEXP _gpbart2_bspline(SEXP xSEXP, SEXP x_obsSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< arma::vec >::type x(xSEXP);
...
RcppExport SEXP _gpbart2_sbart(SEXP x_trainSEXP, SEXP y_trainSEXP, SEXP x_testSEXP, SEXP B_trainSEXP, SEXP B_testSEXP, SEXP DSEXP, SEXP n_treeSEXP, SEXP n_mcmcSEXP, SEXP n_burnSEXP, SEXP tauSEXP, SEXP muSEXP, SEXP tau_muSEXP, SEXP tau_bSEXP, SEXP tau_b_interceptSEXP, SEXP alphaSEXP, SEXP betaSEXP, SEXP a_tauSEXP, SEXP d_tauSEXP, SEXP nuSEXP, SEXP deltaSEXP, SEXP a_deltaSEXP, SEXP d_deltaSEXP, SEXP a_tau_bSEXP, SEXP d_tau_bSEXP, SEXP p_sampleSEXP, SEXP p_sample_levelsSEXP, SEXP intercept_modelSEXP, SEXP stumpSEXP, SEXP aSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    ...
    rcpp_result_gen = Rcpp::wrap(sbart(x_train, y_train, x_test, B_train, B_test, D, n_tree, n_mcmc, n_burn, tau, mu, tau_mu, tau_b, tau_b_intercept, alpha, beta, a_tau, d_tau, nu, delta, a_delta, d_delta, a_tau_b, d_tau_b, p_sample, p_sample_levels, intercept_model, stump, a));
    return rcpp_result_gen;
END_RCPP
}
// mat_init
arma::mat mat_init(int n);
RcppExport SEXP _gpbart2_mat_init(SEXP nSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
...
RcppExport SEXP _gpbart2_vec_init(SEXP nSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< int >::type n(nSEXP);
...
RcppExport SEXP _gpbart2_std_inv(SEXP ASEXP, SEXP diagSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
...
RcppExport SEXP _gpbart2_std_pinv(SEXP ASEXP, SEXP diagSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< arma::mat >::type A(ASEXP);
...
RcppExport SEXP _gpbart2_faster_simple_std_inv(SEXP ASEXP, SEXP diagSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< arma::mat >::type A(ASEXP);
...
RcppExport SEXP _gpbart2_faster_std_inv(SEXP ASEXP, SEXP diagSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< arma::mat >::type A(ASEXP);
...
RcppExport SEXP _gpbart2_rMVN2(SEXP bSEXP, SEXP QSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
...
RcppExport SEXP _gpbart2_rMVNslow(SEXP bSEXP, SEXP QSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< const arma::vec& >::type b(bSEXP);
...
RcppExport SEXP _gpbart2_matrix_mat(SEXP arraySEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
...
// rand_unif
double rand_unif();
RcppExport SEXP _gpbart2_rand_unif() {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
...
RcppExport SEXP _gpbart2_inn_prod_one(SEXP beta_vecSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
...
RcppExport SEXP _gpbart2_inn_prod_two(SEXP beta_vecSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< arma::mat >::type beta_vec(beta_vecSEXP);
...
RcppExport SEXP _gpbart2_inn_prod_three(SEXP beta_vecSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< arma::mat >::type beta_vec(beta_vecSEXP);
...
RcppExport SEXP _gpbart2_array_check(SEXP arr_SEXP) {
BEGIN_RCPP
    Rcpp::RNGScope rcpp_rngScope_gen;
...
static const R_CallMethodDef CallEntries[] = {
    {"_gpbart2_log_dmvn", (DL_FUNC) &_gpbart2_log_dmvn, 2},
    {"_gpbart2_bspline", (DL_FUNC) &_gpbart2_bspline, 2},
    {"_gpbart2_sbart", (DL_FUNC) &_gpbart2_sbart, 29},
    {"_gpbart2_mat_init", (DL_FUNC) &_gpbart2_mat_init, 1},
    {"_gpbart2_vec_init", (DL_FUNC) &_gpbart2_vec_init, 1},
    {"_gpbart2_std_inv", (DL_FUNC) &_gpbart2_std_inv, 2},
    {"_gpbart2_std_pinv", (DL_FUNC) &_gpbart2_std_pinv, 2},
    {"_gpbart2_faster_simple_std_inv", (DL_FUNC) &_gpbart2_faster_simple_std_inv, 2},
    {"_gpbart2_faster_std_inv", (DL_FUNC) &_gpbart2_faster_std_inv, 2},
    {"_gpbart2_rMVN2", (DL_FUNC) &_gpbart2_rMVN2, 2},
    {"_gpbart2_rMVNslow", (DL_FUNC) &_gpbart2_rMVNslow, 2},
    {"_gpbart2_matrix_mat", (DL_FUNC) &_gpbart2_matrix_mat, 1},
    {"_gpbart2_rand_unif", (DL_FUNC) &_gpbart2_rand_unif, 0},
    {"_gpbart2_inn_prod_one", (DL_FUNC) &_gpbart2_inn_prod_one, 1},
    {"_gpbart2_inn_prod_two", (DL_FUNC) &_gpbart2_inn_prod_two, 1},
    {"_gpbart2_inn_prod_three", (DL_FUNC) &_gpbart2_inn_prod_three, 1},
    {"_gpbart2_array_check", (DL_FUNC) &_gpbart2_array_check, 1},
    {NULL, NULL, 0}
};

RcppExport void R_init_gpbart2(DllInfo *dll) {
