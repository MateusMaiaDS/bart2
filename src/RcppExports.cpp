...
RcppExport SEXP _bart2_gamma_pdf(SEXP xSEXP, SEXP aSEXP, SEXP bSEXP) {
BEGIN_RCPP
...
RcppExport SEXP _bart2_r_gamma_pdf(SEXP xSEXP, SEXP aSEXP, SEXP bSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< double >::type x(xSEXP);
...
RcppExport SEXP _bart2_print_mat_subset(SEXP XSEXP) {
BEGIN_RCPP
    Rcpp::RNGScope rcpp_rngScope_gen;
...
RcppExport SEXP _bart2_log_dmvn(SEXP xSEXP, SEXP SigmaSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
...
// cppbart
Rcpp::List cppbart(arma::mat x_train, arma::vec y_train, arma::mat x_test, int n_tree, int node_min_size, int n_mcmc, int n_burn, double tau, double mu, double tau_mu, double alpha, double beta, double a_tau, double d_tau, bool stump);
RcppExport SEXP _bart2_cppbart(SEXP x_trainSEXP, SEXP y_trainSEXP, SEXP x_testSEXP, SEXP n_treeSEXP, SEXP node_min_sizeSEXP, SEXP n_mcmcSEXP, SEXP n_burnSEXP, SEXP tauSEXP, SEXP muSEXP, SEXP tau_muSEXP, SEXP alphaSEXP, SEXP betaSEXP, SEXP a_tauSEXP, SEXP d_tauSEXP, SEXP stumpSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    ...
    rcpp_result_gen = Rcpp::wrap(cppbart(x_train, y_train, x_test, n_tree, node_min_size, n_mcmc, n_burn, tau, mu, tau_mu, alpha, beta, a_tau, d_tau, stump));
    return rcpp_result_gen;
END_RCPP
}
// mat_init
arma::mat mat_init(int n);
RcppExport SEXP _bart2_mat_init(SEXP nSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
...
RcppExport SEXP _bart2_vec_init(SEXP nSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< int >::type n(nSEXP);
...
RcppExport SEXP _bart2_std_inv(SEXP ASEXP, SEXP diagSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
...
RcppExport SEXP _bart2_std_pinv(SEXP ASEXP, SEXP diagSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< arma::mat >::type A(ASEXP);
...
RcppExport SEXP _bart2_faster_simple_std_inv(SEXP ASEXP, SEXP diagSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< arma::mat >::type A(ASEXP);
...
RcppExport SEXP _bart2_log_test(SEXP aSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< double >::type a(aSEXP);
...
RcppExport SEXP _bart2_faster_std_inv(SEXP ASEXP, SEXP diagSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< arma::mat >::type A(ASEXP);
...
RcppExport SEXP _bart2_rMVN2(SEXP bSEXP, SEXP QSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
...
RcppExport SEXP _bart2_rMVNslow(SEXP bSEXP, SEXP QSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< const arma::vec& >::type b(bSEXP);
...
RcppExport SEXP _bart2_matrix_mat(SEXP arraySEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
...
// rand_unif
double rand_unif();
RcppExport SEXP _bart2_rand_unif() {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
...
static const R_CallMethodDef CallEntries[] = {
    ...
    {"_bart2_r_gamma_pdf", (DL_FUNC) &_bart2_r_gamma_pdf, 3},
    {"_bart2_print_mat_subset", (DL_FUNC) &_bart2_print_mat_subset, 1},
    {"_bart2_log_dmvn", (DL_FUNC) &_bart2_log_dmvn, 2},
    {"_bart2_cppbart", (DL_FUNC) &_bart2_cppbart, 15},
    {"_bart2_mat_init", (DL_FUNC) &_bart2_mat_init, 1},
    {"_bart2_vec_init", (DL_FUNC) &_bart2_vec_init, 1},
    {"_bart2_std_inv", (DL_FUNC) &_bart2_std_inv, 2},
    {"_bart2_std_pinv", (DL_FUNC) &_bart2_std_pinv, 2},
    {"_bart2_faster_simple_std_inv", (DL_FUNC) &_bart2_faster_simple_std_inv, 2},
    {"_bart2_log_test", (DL_FUNC) &_bart2_log_test, 1},
    {"_bart2_faster_std_inv", (DL_FUNC) &_bart2_faster_std_inv, 2},
    {"_bart2_rMVN2", (DL_FUNC) &_bart2_rMVN2, 2},
...
RcppExport void R_init_bart2(DllInfo *dll) {
